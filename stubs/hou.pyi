...
class Node(NetworkMovableItem):
    ...
    def copyNetworkBox(self, network_box_to_copy: 'NetworkBox', new_,name: str|None=None, channel_reference_original: bool=False) -> 'NetworkBox': ...
    ...
    def createNetworkDot(self) -> Iterator['NetworkDot']: ...
