...
class QAbstractListModel(PySide6.QtCore.QAbstractItemModel):
    ...
    def columnCount(self, parent: PySide6.QtCore.QModelIndex | PySide6.QtCore.QPersistentModelIndex, /) -> int: ... # type: ignore
    def dropMimeData(self, data: PySide6.QtCore.QMimeData, action: PySide6.QtCore.Qt.DropAction, row: int, column: int, parent: PySide6.QtCore.QModelIndex | PySide6.QtCore.QPersistentModelIndex, /) -> bool: ...
    def flags(self, index: PySide6.QtCore.QModelIndex | PySide6.QtCore.QPersistentModelIndex, /) -> PySide6.QtCore.Qt.ItemFlag: ...
    def hasChildren(self, parent: PySide6.QtCore.QModelIndex | PySide6.QtCore.QPersistentModelIndex, /) -> bool: ... # type: ignore
...
class QBitArray(Shiboken.Object):
    ...
    def __copy__(self, /) -> typing.Self: ...
    def __eq__(self, rhs: PySide6.QtCore.QBitArray | int, /) -> bool: ... # type: ignore
...
class QByteArray(Shiboken.Object):
    ...
    def nullTerminate(self, /) -> PySide6.QtCore.QByteArray: ...
    def nullTerminated(self, /) -> PySide6.QtCore.QByteArray: ...
    @typing.overload
    @staticmethod
...
class QDataStream(PySide6.QtCore.QIODeviceBase):
    ...
    class Version(enum.IntEnum):
        ...
        Qt_6_9                    = 0x16
        Qt_6_10                   = 0x17
        Qt_DefaultCompiledVersion = 0x17
    ...
    @typing.overload
    def __lshift__(self, chr: str, /) -> PySide6.QtCore.QDataStream: ...
    @typing.overload
    ...
    @typing.overload
    def __rshift__(self, chr: str, /) -> PySide6.QtCore.QDataStream: ...
    @typing.overload
...
class QDateTime(Shiboken.Object):
    ...
    @typing.overload
    def __init__(self, year: int, month: int, day: int, h: int, m: int, s: int, ms: int, /, spec: PySide6.QtCore.QTimeZone | PySide6.QtCore.QTimeZone.Initialization = ...) -> None: ...
    @typing.overload
...
class QDir(Shiboken.Object):
    ...
    @typing.overload
    def mkdir(self, arg__1: str, arg__2: PySide6.QtCore.QFileDevice.Permission, /) -> bool: ...
    @typing.overload
    def mkpath(self, arg__1: str, /) -> bool: ...
    @typing.overload
    def mkpath(self, arg__1: str, arg__2: PySide6.QtCore.QFileDevice.Permission, /) -> bool: ...
...
class QFutureInterfaceBase(Shiboken.Object):
    ...
    @typing.overload
    def cancelChain(self, mode: PySide6.QtCore.QFutureInterfaceBase.CancelMode, /) -> None: ...
...
class QLine(Shiboken.Object):
    ...
    def toTuple(self, /) -> typing.Tuple[int, int, int, int]: ...
    @typing.overload
...
class QLineF(Shiboken.Object):
    ...
    def toTuple(self, /) -> typing.Tuple[float, float, float, float]: ...
    @typing.overload
...
class QPointF(Shiboken.Object):
    ...
    def toTuple(self, /) -> typing.Tuple[float, float]: ...
...
class QRangeModel(PySide6.QtCore.QAbstractItemModel):
    ...
    @typing.overload
    def __init__(self, data: collections.abc.Sequence[typing.Any], /, parent: PySide6.QtCore.QObject | None = ..., *, roleNames: typing.Optional[typing.Dict[int, PySide6.QtCore.QByteArray]] = ...) -> None: ...
    @typing.overload
    def __init__(self, list: collections.abc.Iterable, /, parent: PySide6.QtCore.QObject | None = ..., *, roleNames: typing.Optional[typing.Dict[int, PySide6.QtCore.QByteArray]] = ...) -> None: ...
    ...
    def mimeData(self, indexes: collections.abc.Sequence[PySide6.QtCore.QModelIndex], /) -> PySide6.QtCore.QMimeData: ...
    def mimeTypes(self, /) -> typing.List[str]: ...
    def moveColumns(self, sourceParent: PySide6.QtCore.QModelIndex | PySide6.QtCore.QPersistentModelIndex, sourceColumn: int, count: int, destParent: PySide6.QtCore.QModelIndex | PySide6.QtCore.QPersistentModelIndex, destColumn: int, /) -> bool: ...
    def moveRows(self, sourceParent: PySide6.QtCore.QModelIndex | PySide6.QtCore.QPersistentModelIndex, sourceRow: int, count: int, destParent: PySide6.QtCore.QModelIndex | PySide6.QtCore.QPersistentModelIndex, destRow: int, /) -> bool: ...
    def multiData(self, index: PySide6.QtCore.QModelIndex | PySide6.QtCore.QPersistentModelIndex, roleDataSpan: PySide6.QtCore.QModelRoleDataSpan | PySide6.QtCore.QModelRoleData, /) -> None: ...
    @typing.overload
    def parent(self, /) -> PySide6.QtCore.QObject: ...
    @typing.overload
    ...
    def roleNames(self, /) -> typing.Dict[int, PySide6.QtCore.QByteArray]: ...
    def rowCount(self, /, parent: PySide6.QtCore.QModelIndex | PySide6.QtCore.QPersistentModelIndex = ...) -> int: ...
    def setData(self, index: PySide6.QtCore.QModelIndex | PySide6.QtCore.QPersistentModelIndex, data: typing.Any, /, role: int = ...) -> bool: ...
    def setHeaderData(self, section: int, orientation: PySide6.QtCore.Qt.Orientation, data: typing.Any, /, role: int = ...) -> bool: ...
    def setItemData(self, index: PySide6.QtCore.QModelIndex | PySide6.QtCore.QPersistentModelIndex, data: typing.Dict[int, typing.Any], /) -> bool: ...
    def setRoleNames(self, names: typing.Dict[int, PySide6.QtCore.QByteArray], /) -> None: ...
    def sibling(self, row: int, column: int, index: PySide6.QtCore.QModelIndex | PySide6.QtCore.QPersistentModelIndex, /) -> PySide6.QtCore.QModelIndex: ...
    def sort(self, column: int, /, order: PySide6.QtCore.Qt.SortOrder = ...) -> None: ...
    def span(self, index: PySide6.QtCore.QModelIndex | PySide6.QtCore.QPersistentModelIndex, /) -> PySide6.QtCore.QSize: ...
    def supportedDragActions(self, /) -> PySide6.QtCore.Qt.DropAction: ...
    def supportedDropActions(self, /) -> PySide6.QtCore.Qt.DropAction: ...
...
class QSortFilterProxyModel(PySide6.QtCore.QAbstractProxyModel):
    ...
    def endFilterChange(self, /, directions: PySide6.QtCore.QSortFilterProxyModel.Direction = ...) -> None: ...
    def fetchMore(self, parent: PySide6.QtCore.QModelIndex | PySide6.QtCore.QPersistentModelIndex, /) -> None: ...
...
class QXmlStreamWriter(Shiboken.Object):
    ...
    def device(self, /) -> PySide6.QtCore.QIODevice: ...
    def error(self, /) -> PySide6.QtCore.QXmlStreamWriter.Error: ...
    def errorString(self, /) -> str: ...
    def hasError(self, /) -> bool: ...
    def raiseError(self, message: str, /) -> None: ...
...
class Qt(Shiboken.Object):
    ...
    class ItemDataRole(enum.IntEnum):
        ...
        RangeModelDataRole        = 0x28
        FileInfoRole              = 0xfc
        RemoteObjectsCacheRole    = 0xff
        StandardItemFlagsRole     = 0xff
        UserRole                  = 0x100
