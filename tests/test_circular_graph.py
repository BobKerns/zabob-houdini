...
def test_circular_three_node_cycle(hython_test):
    ...
    result = hython_test("h_test_circular_three_node_cycle")
...
def test_self_referencing_node(hython_test):
    ...
    result = hython_test("h_test_self_referencing_node")
...
def test_two_node_cycle(hython_test):
    ...
    result = hython_test("h_test_two_node_cycle")
...
def test_complex_intersecting_cycles(hython_test):
    ...
    result = hython_test("h_test_complex_intersecting_cycles")
